...
partition_type = input("Please input The value of the partition type byte or 00 to close program> ")
while partition_type != "00":
    ...
    # Print a divider of # between iterations
    print("#"*20)

    # We need line repeated here again, to be able to update the condition for the next iteration
    partition_type = input("Please input The value of the partition type byte or 00 to close program> ")
